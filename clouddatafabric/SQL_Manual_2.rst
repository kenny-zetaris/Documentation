...
::
  ...
  ADD USER WITH (  
    ...
    level: admin | general
    password doesn't allow white spaces.
...
""""""""""""""""""""""""""""""
The Zetaris Cloud Data Fabric provides Role Based Access which limits a users to access a specific set of data. 
...
Roles are case insensitive and there are 4 predefined roles:
  admin
  none
  all
  default
...
::
  ...
  Create Role
  CREATE ROLE role_name [DESCRIBE BY "thare the details of the role"]
